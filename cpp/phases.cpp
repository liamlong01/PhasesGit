...
void filedata(int fn)
{
  ...
  */
  ...
  ifstream file8;
  ifstream file9;
  file3.open("c:/phases/mesh1.dat");
  file4.open("c:/phases/sample1.prj");
  file5.open("c:/phases/mesh1.dat");
  file6.open("c:/phases/bc1.dat");
  file7.open("c:/phases/ic1.dat");
  file8.open("c:/phases/output.dat");
  file9.open("c:/phases/custom1.dat");
