...
// Section included: interface with CFDV Viewer
// #pragma once // added to phasesb.h
// #include "afx.h" // added to phasesb.h
// #include "StdAfx.h" // added to phasesb.cpp
// #include "phasesb.h" // added to phasesb.cpp
...
#include "variaInit.h"  //Declares and initializes all global variables
#include "functInit.h"  //Declares all functions

// Exported EXE -> console
// 1. New Project -> Win32 Project -> console application
// 2. use: 'void main()' and both 'double Adda()' declarations
// 3. remove: '#include <windows.h>' and 'double _declspec ...'
// 4. Debug -> Build -> c:\ ... \debug\phasesb.dll created
// CFDV Viewer: declare 'double Adda()' in phasesb.cpp and CFDVDlg
  ...
  for (vk = 1; vk <= tvk; ++vk) {
    ...
    if ((se == 1) || (se == 12) || (se == 13) || (se == 4)) {
      ...
      for (cmf = 1; cmf <= tk; ++cmf) {
        ...
        if (ao != 2) {
          nullmx(r, z, c, aq);
          assmbl(1, 1, 1, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
        ...
        // C equation: droplet flow
          ...
          nullmx(r, z, c, aq);
          assmbl(6, 1, 1, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
          assmbl(7, 1, 1, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
          bndry(1, 1, 1, nsrf, fo, bc, c, r);
          genul(1, c, nym, nnp, nnpm, band3);
          forbak(1, c, z, r, nym, nnp, nnpm, band3);
          for (j = 1; j <= nnp; ++j) {
    ...
    cnt3000: if ((se == 2) || (se == 12) || (se == 23)
     || (se == 4)) {
      for (tph = 1; tph <= tk; ++tph) {
        ...
        nullmx(r, z, c, aq);
        assmbl(2, 1, 1, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
    ...
    if ((se == 3) || (se == 13) || (se == 23) || (se == 4)) {
      for (n = 1; n <= tk; ++n) {
        ...
        nullmx(r, z, c, aq);
        assmbl(3, 1, 3, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
        assmbl(4, 2, 3, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
        assmbl(5, 3, 3, nel, nelm, band3, df, fo, nn, aq, c, rq, r);
...
void filedata(int fn)
{
  ...
  ifstream file8;
  ifstream file9;
  file3.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\mesh2.dat");
  file4.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\sample2.prj")
  file5.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\mesh2.dat");
  file6.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\bc2.dat");
  file7.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\ic1.dat");
  //file8.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\");
  file9.open("C:\Users\Peter\Desktop\CFD\Winter 2016\Nicole\Data\custom2.dat");
